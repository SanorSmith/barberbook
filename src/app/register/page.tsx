    ...
    <div className="min-h-screen flex -mt-20">
      ...
      <div className="w-full lg:w-[60%] bg-obsidian flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <h2 className="font-serif text-3xl text-cream mb-2">Create Account</h2>
          <p className="text-silver mb-8">Join us for a premium grooming experience</p>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="block text-xs text-silver uppercase tracking-wider mb-1">Full Name</label>
              <input 
                type="text" 
                value={fullName}
                onChange={(e) => setFullName(e.target.value)}
                className="w-full bg-charcoal border border-slate rounded-lg p-3 text-cream focus:border-gold outline-none transition-colors"
                required
              />
            </div>
            <div>
            ...
            <label className="flex items-center text-sm text-silver cursor-pointer">
              <input type="checkbox" className="mr-2 rounded border-slate bg-charcoal text-gold focus:ring-0" required /> 
          ...
          <button className="w-full bg-white text-gray-900 py-3 rounded-lg font-medium flex items-center justify-center hover:bg-gray-100 transition-colors">
